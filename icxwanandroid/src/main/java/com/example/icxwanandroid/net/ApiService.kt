...
import com.example.icxwanandroid.bean.*
...
interface ApiService {
     ...
     */
    @POST("/user/register")
    fun registerWanAndroid(@Query("username") username: String,
                           @Query("password") password: String,
                           @Query("repassword") repassword : String) : Observable<LoginResponse>

    @POST("/user/register")
    @FormUrlEncoded
    fun registerWanAndroid2(
